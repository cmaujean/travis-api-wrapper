...
exports.ua = "travis-api-wrapper - v0.01 - (cmaujean@gmail.com)";
exports.options = {
  host: "travis-ci.org",
  port: 80,
  headers: {
...
// @param cb = function(err, data) {...do something with data...}; 
// @returns nothing
exports.repositories = function(cb) { get_data(exports.options, '/repositories.json', cb) };
...
// @param cb = function(err, data) {...do something with data...};
// @returns nothing
exports.repository = function(repo, cb) { get_data(exports.options, '/' + repo + '.json', cb) };

// fetches data about all the builds for a given repository from travis-ci.org json api and passes it to the callback
// @param repo = "name/repository";
// @param cb = function(err, data) {...do something with data...};
// @returns nothing
exports.builds = function(repo, cb) { get_data(exports.options, '/' + repo + '/builds.json', cb) };
...
// @returns nothing
exports.build = function(repo, id, cb) { get_data(exports.options, '/' + repo + '/builds/' + id + '.json', cb) };
